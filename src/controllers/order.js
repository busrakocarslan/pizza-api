...
module.exports = {
  list: async (req, res) => {
    /*
                ...
                `
            */
    const data = await res.getModelList(Order, {}, ["userId", "pizzaId"]);// iki adet populeta yapacağım alan olduğundan array olarak yazdık çünkü 3 parametre alab liyor ancak 
    res.status(200).send({
      error: false,
  ...
  create: async (req, res) => {
    ...
    */
   //! burada bulunan price pizza modelden geleceğinden oradan alıyoruz!!!
